...
source('support/get_varmapping_L0Fi_PW.R')
...
## load('')
## save('dataL0', 'dataL1', 'dataL2', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', file = paste0('data_pw_work', WORK, '.RData'))
### save('dataL0', 'dataL1', 'dataL2', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', file = paste0('data_northsea_pw_work', WORK, '.RData'))
### save('dataL0', 'dataL1', 'dataL2', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', file = paste0('data_balticsea_pw_work', WORK, '.RData'))
### save('dataL0', 'dataL1', 'dataL2', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', file = paste0('data_', sea, '_pw_work', WORK, '.RData'))
## save('dataL0', 'dataL1', 'dataL2', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', file = paste0(savePrefix, 'data_', sea, '_pw_work', WORK, '.RData'))

# directories ----
varmappingFileName = paste0('../control_files/variablemapping_pw_work', WORK,'.csv')
...
# outdir = paste0('../output/STATIONS_PW_WORK', WORK)
outdir = paste0('/gfs1/work/mvkdneum/HBM/RESULTS/EVALUATION/stations_annual/PW_WORK', WORK)
# inDir = '/silod4/dneumann/HBM/RESULTS/EVALUATION'
# inDir = '/media/neumannd/private_dell/HBM/RESULTS/EVALUATION'
# inDir = '/media/neumannd/private_dell/HBM/RESULTS/ONE_DAY'
...
ncFiles = list()
# filenamePrefix = list('ERGOM'='PW_WORKA/p', 'HBM'='PW_WORKE/p')
# filenameSuffix = list('ERGOM'='00_2012010100.nc',
#                       'HBM'='00_2012010100.nc')
filenamePrefix = list('ERGOM'='p', 'HBM'='p')
filenameSuffix = list('ERGOM'=paste0('PW_WORK', WORK, '_merge_mean_2012.nc'),
                      'HBM'='PW_WORKE_merge_mean_2012.nc')
...
if (saveData && readL0 && exists('dataL0')) save('dataL0', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', 
                             file = paste0(savePrefix, 'dataL0_', sea, '_pw_work', WORK, '.RData'))
...
if (saveData && calcL1 && exists('dataL1')) save('dataL1', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', 
                             file = paste0(savePrefix, 'dataL1_', sea, '_pw_work', WORK, '.RData'))
...
if (saveData && calcL2 && exists('dataL2')) save('dataL2', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', 
                             file = paste0(savePrefix, 'dataL2_', sea, '_pw_work', WORK, '.RData'))
if (saveData && exists('dataL2') && exists('dataL1') && exists('dataL0')) save('dataL0', 'dataL1', 'dataL2', 'grids', 'varnames', 'varmapping', 'varlist', 'stations', 'ncFileNames', 
                   file = paste0(savePrefix, 'data_', sea, '_pw_work', WORK, '.RData'))
