...
varlistFileName = '../control_files/variablelist_neumannd3_noSil.csv'
...
outdir = paste0('/gfs1/work/mvkdneum/HBM/RESULTS/EVALUATION/stations_annual/MR_WORK', WORKb)
...
filenameSuffix = list('ERGOM'=paste0('MR_WORK', WORKb, '_merge_mean_2012.nc'),
                      'HBM'=paste0('MR_WORKE_merge_mean_2012.nc'))
