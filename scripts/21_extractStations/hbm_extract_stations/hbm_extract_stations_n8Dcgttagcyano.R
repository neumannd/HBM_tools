...
# load('test_dataL0_all_mr_workEcgttagcyano.RData')
...
# load('test_dataL1_all_mr_workEcgttagcyano.RData')
...
# do fixation through cyano data ----
if (doFixat) {
  print('do fixation: extract L1')
  dataFixatL1 = extract_tag_data(dataL1, 'atmosfix', c('ship', 'river', 'atmos', 'agri', 'atmosfix'), sep = '_')
  print('do fixation: write L1')
  tmpVarnames = list('L1' = intersect(names(dataFixatL1), varnames$L1))
  ncFiles$L1 = createL1file(stations, tmpVarnames, varmapping, dataFixatL1, outdir, grids, '_fixation')
  print('do fixation: extract L2')
  dataFixatL2 = list()
  for(iVar in names(varlist)) {
    dataFixatL2[[iVar]] = list()
    dataFixatL2[[iVar]]$data = calculate_variable(varlist[[iVar]]$formula, dataFixatL1)
  }
  print('do fixation: write L2')
  ncFiles$L2 = createL2file(stations, varnames, varlist, varmapping, dataFixatL2, outdir, grids, '_fixation')
}
