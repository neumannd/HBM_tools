get_varmapping_L0Fi = function(WORK) {
  ...
  if (WORK == 'A') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
                        'mole_concentration_of_phosphate_from_warnow_P_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_warnow_P_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_warnow_P_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_warnow_P_in_seawater',
                        ...
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_warnow_P_in_seawater',
                        'mole_concentration_of_ammonium_from_warnow_N_in_seawater',
                        'mole_concentration_of_nitrate_from_warnow_N_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_warnow_N_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_warnow_N_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_warnow_N_in_seawater',
                        ...
                        'mole_concentration_of_labile_dissolved_organic_nitrogen_from_warnow_N_expressed_as_nitrogen_in_seawater')
  }
  ...
  if (WORK == 'A') {
    FILE_L0$bendat    = c(FILE_L0$bendat,
                        'mole_concentration_of_nitrogen_from_warnow_P_in_the_sediment',
                        'mole_concentration_of_nitrogen_from_warnow_N_in_the_sediment')
  }
