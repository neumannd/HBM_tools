get_varmapping_L0Fi = function(WORK) {
  ...
  if (WORK == 'DcgttagriverN' || WORK == 'DcgttagriverNP' || WORK == 'EcgttagriverN' || WORK == 'EcgttagriverNP') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
                        'mole_concentration_of_ammonium_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_nitrate_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_zooplankton_expressed_as_nitrogen_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_protozooplankton_expressed_as_nitrogen_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_riverineN_inflow_in_seawater',
                        'mole_concentration_of_labile_dissolved_organic_nitrogen_from_riverineN_inflow_expressed_as_nitrogen_in_seawater')
  }
  if (WORK == 'DcgttagriverP' || WORK == 'DcgttagriverNP' || WORK == 'EcgttagriverP' || WORK == 'EcgttagriverNP') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
                        'mole_concentration_of_phosphate_from_riverineP_inflow_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_riverineP_inflow_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_riverineP_inflow_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_riverineP_inflow_in_seawater',
                        'mole_concentration_of_zooplankton_expressed_as_nitrogen_from_riverineP_inflow_in_seawater',
                        'mole_concentration_of_protozooplankton_expressed_as_nitrogen_from_riverineP_inflow_in_seawater',
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_riverineP_inflow_in_seawater')
  }
  if (WORK == 'Dcgttagrivers_rhine_ems' || WORK == 'Dcgttagrivers_weser_elbe' || WORK == 'DcgttagtworiversNP' || WORK == 'DcgttagtworiversN') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
                        'mole_concentration_of_ammonium_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_nitrate_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_zooplankton_expressed_as_nitrogen_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_protozooplankton_expressed_as_nitrogen_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_river1N_inflow_in_seawater',
                        'mole_concentration_of_labile_dissolved_organic_nitrogen_from_river1N_inflow_expressed_as_nitrogen_in_seawater',
                        'mole_concentration_of_ammonium_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_nitrate_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_zooplankton_expressed_as_nitrogen_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_protozooplankton_expressed_as_nitrogen_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_river2N_inflow_in_seawater',
                        'mole_concentration_of_labile_dissolved_organic_nitrogen_from_river2N_inflow_expressed_as_nitrogen_in_seawater')
  }
  if (WORK == 'Dcgttagrivers_rhine_ems' || WORK == 'Dcgttagrivers_weser_elbe' || WORK == 'DcgttagtworiversNP' || WORK == 'DcgttagtworiversP') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
                        'mole_concentration_of_phosphate_from_river1P_inflow_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_river1P_inflow_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_river1P_inflow_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_river1P_inflow_in_seawater',
                        'mole_concentration_of_zooplankton_expressed_as_nitrogen_from_river1P_inflow_in_seawater',
                        'mole_concentration_of_protozooplankton_expressed_as_nitrogen_from_river1P_inflow_in_seawater',
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_river1P_inflow_in_seawater',
                        'mole_concentration_of_phosphate_from_river2P_inflow_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_river2P_inflow_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_river2P_inflow_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_river2P_inflow_in_seawater',
                        'mole_concentration_of_zooplankton_expressed_as_nitrogen_from_river2P_inflow_in_seawater',
                        'mole_concentration_of_protozooplankton_expressed_as_nitrogen_from_river2P_inflow_in_seawater',
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_river2P_inflow_in_seawater')
  }
  if (WORK=='Dcgttagship' || WORK=='Dcgttagshipatmos' || WORK=='Dcgttagshipriver' || WORK=='Ecgttagship' || WORK=='Ecgttagshipatmos' || WORK=='Ecgttagshipriver') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
  ...
  if (WORK=='Dcgttagatmos' || WORK=='Dcgttagshipatmos' || WORK=='Ecgttagatmos' || WORK=='Ecgttagshipatmos') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
  ...
  if (WORK=='Dcgttagcyano' || WORK=='Ecgttagcyano') {
    FILE_L0$biodat  = c(FILE_L0$biodat,
                        'mole_concentration_of_ammonium_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_nitrate_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_diatoms_expressed_as_nitrogen_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_flagellates_expressed_as_nitrogen_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_cyanobacteria_expressed_as_nitrogen_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_zooplankton_expressed_as_nitrogen_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_protozooplankton_expressed_as_nitrogen_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_detritus_expressed_as_nitrogen_from_atmospheric_fixation_in_seawater',
                        'mole_concentration_of_labile_dissolved_organic_nitrogen_from_atmospheric_fixation_expressed_as_nitrogen_in_seawater')
  }
  ...
  if (WORK == 'DcgttagriverN' || WORK == 'DcgttagriverNP') {
    FILE_L0$bendat    = c(FILE_L0$bendat,
                        'mole_concentration_of_nitrogen_from_riverineN_inflow_in_the_sediment')
  }
  if (WORK == 'DcgttagriverP' || WORK == 'DcgttagriverNP') {
    FILE_L0$bendat    = c(FILE_L0$bendat,
                        'mole_concentration_of_nitrogen_from_riverineP_inflow_in_the_sediment')
  }
  if (WORK == 'Dcgttagrivers_rhine_ems' || WORK == 'Dcgttagrivers_weser_elbe' || WORK == 'DcgttagtworiversNP' || WORK == 'DcgttagtworiversN') {
    FILE_L0$bendat    = c(FILE_L0$bendat,
                        'mole_concentration_of_nitrogen_from_river1N_inflow_in_the_sediment',
                        'mole_concentration_of_nitrogen_from_river2N_inflow_in_the_sediment')

  }
  if (WORK == 'Dcgttagrivers_rhine_ems' || WORK == 'Dcgttagrivers_weser_elbe' || WORK == 'DcgttagtworiversNP' || WORK == 'DcgttagtworiversP') {
    FILE_L0$bendat    = c(FILE_L0$bendat,
                        'mole_concentration_of_nitrogen_from_river1P_inflow_in_the_sediment',
                        'mole_concentration_of_nitrogen_from_river2P_inflow_in_the_sediment')
  ...
  if (WORK=='Dcgttagcyano' || WORK=='Ecgttagcyano') {
    FILE_L0$bendat    = c(FILE_L0$bendat,
                        'mole_concentration_of_nitrogen_from_atmospheric_fixation_in_the_sediment')
  }
